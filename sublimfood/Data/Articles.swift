...
struct Articles {
    static let all = [
        ...
        ArticleModel(title: "Comment recycler son marc de café en produits de beauté !",
                     image: "marc-de-café",
                     caption: "caption",
                     content: "Tonifiant et adoucissant, le marc de café a aussi pour particularité d'être gainant et décongestionnant. On peut l'utiliser de différentes façons : en gommage, en masque ou encore en soin exfoliant. Les cheveux foncés vont l'adorer car il va leur redonner de l'éclat. La caféine est par ailleurs un composant que l'on retrouve dans de nombreuses crèmes anti-cellulite.t",
                     type: .cosmetic)
    ]
